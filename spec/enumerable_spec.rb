...
RSpec.describe Lista do
    ...
    describe "Enumerable en Lista de Etiquetas" do
        ...
        it "collect de Enumerable" do
            lista.insertar_tail(@Crema_Chocolate.valorenergetico)
            lista.insertar_tail(@Galletas.valorenergetico)
            lista.insertar_tail(@Arroz.valorenergetico)
            expect(@lista.collect{|i| i*2}).to eq([4460,2882,4236])
        end
        ...
        it "select de Enumerable" do
            ...
            lista.insertar_tail(@Galletas.valorenergetico)
            lista.insertar_tail(@Arroz.valorenergetico)
            expect(@lista.find_all{|i| i%2==0}).to eq([4460,2882,4236])
        end
        ...
        it "sort de Enumerable" do
            ...
            expect(@lista.sort).to eq([4460,4236,2882]) 
        end
    end
    ...
    describe "Enumerable en Lista de Individuo" do
        ...
        it "collect de Enumerable" do
            ...
            lista.insertar_tail(@Carolina.edad)
            expect(@lista.collect{|i| i*2}).to eq([72,52,54])
        end
