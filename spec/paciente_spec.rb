...
RSpec.describe Paciente do
    before :all do
        @lista = Lista.new()
        @paciente1 = Paciente.new(1, "Natalia ", "Gutiérrez  ", 36, "Mujer", "10-12-86", "Cantante", "Si",  1.60, 50.5, 47.5, 56.6, 58.2, 33.7, 80.5, 25.6, 42.3)
        @paciente2 = Paciente.new(2, "Juan Carlos", " Ozuna", 26, "Hombre", "13-03-92", "Panadero", "No",  1.65, 75.5, 73.5, 21.5, 27.5, 13.6, 52.7, 26.8, 90.1)
        @paciente3 = Paciente.new(3, "Benito", "Martínez", 24, "Hombre", "10-03-94", "Agricultor", "Si",  1.80, 64.3, 64.0, 15.0, 28.5, 75.6, 68.6, 36.5, 48.7)
        @paciente4 = Paciente.new(4, "Rebeca ", "Gomez", 24, "Mujer", "02-03-97", "Pintor", "No",  1.75, 80.5, 37.5, 69.7, 43.3, 40.0, 38.5, 60.5, 33.5)
        @paciente5 = Paciente.new(5, "José", "Balvin", 33, "Hombre", "07-05-85", "Profesor", "Si",  1.50, 48.0, 79.4, 78.5, 63.5, 19.4, 50.5, 14.4, 16.2, )
        @paciente6 = Paciente.new(6, "Carolina", "Navarro", 27, "Mujer", "14-02-91", "Actor", "No",  1.65, 55.0, 76.5, 65.6, 12.6, 31.4, 77.2, 18.6, 55.5)
    end 
